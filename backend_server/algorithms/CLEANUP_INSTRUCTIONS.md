...
2. `step2_fixed_slots.js` - Block fixed OEC/PEC slots
3. `step3_schedule_labs_v2.js` - Schedule labs with batches
4. `step4_schedule_theory_breaks.js` - Schedule theory and breaks
5. `step5_assign_classrooms.js` - Assign classrooms to theory slots
...
## ❌ DELETE THESE FILES (Duplicates/Obsolete)

1. **`step5_assign_teachers.js`** - OLD/DUPLICATE
